...
let list = findInvalidCards(batch);
// console.log(idInvalidCardCompanies(list));
console.log(idInvalidCardCompanies([valid3, invalid1, invalid2, invalid5]));
